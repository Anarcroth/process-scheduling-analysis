...
\begin{ganttchart}[
  ...
  \gantttitle{RR \textbf{TQ = 2}}{20} \\
  \gantttitlelist{1,...,20}{1} \\
  \ganttbar[bar/.append style={fill=pr1}]{9479}{1}{2} \\
  \ganttbar[bar/.append style={fill=pr3}]{7470}{3}{4}
  \ganttbar[bar/.append style={fill=pr3}]{7470}{11}{11} \\
  \ganttbar[bar/.append style={fill=pr4}]{2b62}{5}{6}
  \ganttbar[bar/.append style={fill=pr4}]{2b62}{12}{13}
  \ganttbar[bar/.append style={fill=pr4}]{2b62}{18}{18} \\
  \ganttbar[bar/.append style={fill=pr4}]{047c}{7}{8}
  \ganttbar[bar/.append style={fill=pr4}]{047c}{14}{15}
  \ganttbar[bar/.append style={fill=pr4}]{047c}{19}{19} \\
  \ganttbar[bar/.append style={fill=pr4}]{d19c}{9}{10}
  \ganttbar[bar/.append style={fill=pr4}]{d19c}{16}{17}
  \ganttbar[bar/.append style={fill=pr4}]{d19c}{20}{20} \\
\end{ganttchart}
